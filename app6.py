...
# # New function to provide auto-suggestions based on the search query
...
#     suggestions = movies[movies['original_title'].str.contains(query, case=False, na=False)]
#     suggestions_list = suggestions['original_title'].tolist()
#     return jsonify(suggestions_list[:10])  # Return top 10 suggestions
